                ...
                <div className="auth-inner">
                    <Form onSubmit={this.loginHandler}>
                        ...
                        <div className="form-group">
                            ...
                            <input type="text" className="form-control" placeholder="Enter Username" onChange={this.changeHandlerUsername} required />
                        </div>

                        <div className="form-group">
                            <label>Password</label>
                            <input type="password" className="form-control" placeholder="Enter password" onChange={this.changeHandlerPassword} required />
                        </div>
